...
#task3core
from task3core import getidbydocument,defgetwordbyid,defgetidbyword,rawtermfrequency,getdocumentbyid
...
writefile("rtf.txt",indexer)
        #print(j)
        #print(getidbydocument(j))
        #print(getdocumentbyid(getidbydocument(j)))
